 ...
 * SOFTWARE.
 */
package com.caoccao.javet.benchmark.app;
...
/**
 * Simple benchmark for GraalJS, Javet and Nashorn.
 */
public class App {
    ...
    private static long benchJavet() {
        System.out.println("=== Javet ===");
        long sum = 0L;
        // The test script cannot run under strict mode.
        ...
        try (V8Runtime v8Runtime = V8Host.getV8Instance().createV8Runtime()) {
            ...
            if (WARMUP_ENABLED) {
                System.out.println("warming up ...");
                for (int i = 0; i < WARMUP; i++) {
                    v8Runtime.getGlobalObject().invokeVoid("primesMain");
                }
            }
            System.out.println("warmup finished, now measuring");
            for (int i = 0; i < ITERATIONS; i++) {
